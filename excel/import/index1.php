...
$cart_id = 0;
                    for($row =2; $row <= $total_rows; $row++) {
                        $query = "insert into `product` (product_code, `product_name`, product_img_1, product_price, `product_price_sale`, `product_shape`, product_stock, `product_sub_info2`, `product_content`, product_sub_info1, friendly_url, title_seo) VALUES ";
                        //Read a single row of data and store it as a array.
                        //This line of code selects range of the cells like A1:D1
                        $single_row = $sheet->rangeToArray('C' . $row . ':' . $total_columns . $row, NULL, TRUE, FALSE);
                        echo "<tr>";
                        //Creating a dynamic query based on the rows from the excel file
                        $query .= "(";
                        $query1 = "(";
                        ...
                        $sql_vn = "INSERT INTO product_languages (lang_product_code, lang_product_name, lang_product_sub_info2, lang_product_content, lang_product_sub_info1, friendly_url, title_seo, languages_code, product_id) VALUES ".$query1."'vn', $product_id)";//echo $sql_vn.'<br>';
                         mysqli_query($conn_vn, $sql_vn);
                        $sql_en = "INSERT INTO product_languages (lang_product_code, lang_product_name, lang_product_sub_info2, lang_product_content, lang_product_sub_info1, friendly_url, title_seo, languages_code, product_id) VALUES ".$query1."'en', $product_id)";//echo $sql_en.'<br>';
