...
$cart_id = 0;
                    for($row =2; $row <= $total_rows; $row++) {
                        $query = "insert into `product` (productcat_ar, product_code, `product_name`, product_img_1, product_price, `product_price_sale`, `product_shape`, product_stock, `product_sub_info2`, `product_content`, product_sub_info1, friendly_url, title_seo) VALUES ";
                        //Read a single row of data and store it as a array.
                        //This line of code selects range of the cells like A1:D1
