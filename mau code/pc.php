...
$objPHPExcel->getActiveSheet()->mergeCells('A6:E7');
$objPHPExcel->setActiveSheetIndex(0)
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C11', 'Số lượng')
            ->setCellValue('D11', 'Giá')
            ->setCellValue('E11', 'Tổng');
            // ->setCellValue('F1', 'Đơn giá');
            // ->setCellValue('G1', 'Thành tiền');
 $objPHPExcel->getActiveSheet()->getStyle('A11:E11')->getFill()->applyFromArray(array(
...
foreach ($_SESSION['shopping_cart'] as $item) {
	...
	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C'.$i, $item['product_quantity'])
            ->setCellValue('D'.$i, number_format($item['product_price']).' đ')
            // ->setCellValue('E'.$i, 1)
            ->setCellValue('E'.$i, number_format($item['product_price']*$item['product_quantity']).' đ');
