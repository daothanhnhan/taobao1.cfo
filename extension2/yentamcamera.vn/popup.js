  ...
  checkButton.addEventListener('click', function() {
    chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
        chrome.tabs.sendMessage(tabs[0].id, {method: "changePage"}, function(response) {
          ...
          des_seo = des_seo.trim();
          des_seo = encodeURIComponent(des_seo);
          ...
          /////////////
          nguon_goc_text = response.nguon_goc_text;
          nguon_goc_text = nguon_goc_text.trim();
          nguon_goc_text = encodeURIComponent(nguon_goc_text);
          /////////////
          // alert(content);
          img = response.img;
          ...
          xhttp.send("name="+name+"&price1="+price1+"&price2="+price2+"&des="+des1+"&content="+content+"&img="+img+"&code="+code+"&brand="+nguon_goc_text+"&img_content="+img_content+"&content1="+content1+"&content2="+content2+"&des_seo="+des_seo);
        });
      });
  }, false);
