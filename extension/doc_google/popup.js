  ...
  checkButton.addEventListener('click', function() {
    chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
        chrome.tabs.sendMessage(tabs[0].id, {method: "changePage"}, function(response) {
          ...
          var mo_ta = response.mo_ta;//alert(mo_ta);
          var the_alt = response.the_alt;//alert(the_alt);
          ...
          //   img_src += '<a href="https://www.thietbiminhhuy.com/'+img[i]+'" class="img_product" download><img src="https://www.thietbiminhhuy.com/'+img[i]+'" width="100"></a>';
          // }
          ...
          // xhttp.send();
          xhttp.open("POST", "http://taobao1.cafelink.org/extension/doc_google_p/product.php");
          xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          xhttp.send("name="+name+"&mo_ta="+mo_ta+"&the_alt="+the_alt+"&content="+content+"&img_content="+img_content);
        });
      });
  }, false);
