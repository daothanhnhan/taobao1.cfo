...
// alert('start');
			...
			document.getElementById("list_danh_muc").value = request.list_danh_muc;
			document.getElementById("list_anh").value = request.list_anh;
			document.getElementById("image_content").value = request.image_content;
			...
			//////////////////////
			document.getElementById("editor0").setAttribute("name", "1");
			var des = document.getElementById("editor0");
			var textarea_content = document.createElement('TEXTAREA'); 
			textarea_content.name = "product_des";
			textarea_content.value = request.des; 
			des.parentNode.appendChild(textarea_content);
			/////////////////////
