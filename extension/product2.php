<?php 
	...
	$sql = "UPDATE product SET name = '$name', price = '$price1', price_sale = '$price2', des = '$des', note = '$content', image = '$img', product_code = '$code', list_danh_muc = '$brand', image_content = '$img_content' WHERE id = 2";
