<?php 
	...
	$sql = "UPDATE product SET name = '$name', price = '$price1', price_sale = '$price2', des = '$des', note = '$content', image = '$img', product_code = '$code', list_danh_muc = '$brand', image_content = '$img_content', content_1 = '$content1', content_2 = '$content2', des_seo = '$des_seo' WHERE id = 2";
