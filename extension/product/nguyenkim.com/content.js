...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var price = document.getElementsByClassName("product_info_price_value-real")[0];

            if (price) {
            	var price1 = document.getElementsByClassName("product_info_price_value-real")[0];
	            ...
	            // alert(price2);
	            var price2 = document.getElementsByClassName("nk-price-final")[0];
	            price2 = price2.innerText;
	            price2 = price2.replace(/\D/gm,"");
	            // alert(price2);
            } else {
            	// alert('1');
            	var price1 = document.getElementsByClassName("nk-price-final")[0];//alert(price1);
            ...
            var des = document.getElementsByClassName("productInfo_description")[0];
            ...
            // des = '';
            var content = document.getElementById("productSpecification_fullContent");//alert('1');
            var content1_get = document.getElementById("content_description");//alert('2');
            if (content1_get) {
            	var content1 = document.getElementById("content_description");
            } else {
            	content1 = '';
            }
            // alert('3');
            ...
            var ul_img = document.getElementsByClassName("nk-product-thumnbImg")[0];
            var img = ul_img.getElementsByTagName("li");
			...
			for (i=0;i<img_pro_arr.length;i++) {
				...
				link_src = link_src.replace('70/40', '600/336');
				// alert(src[0]);
