...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            // price2 = price2.replaceAll('.', '');
            // alert(price2);
            var des = document.getElementsByTagName("ul")[0];
            ...
            var div_title = document.getElementsByClassName("summary")[0].previousElementSibling;
            // alert(div_title.innerHTML);
            des = div_title.innerHTML;
            des = des + '<br>';
            ...
            // var img = document.getElementsByClassName("fotorama__stage__frame");
