...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var des = document.getElementsByClassName("km-sp")[0];
            ...
            // des = '';
            // alert('1');
            var content = document.getElementById("thong-tin-san-pham");
            if (content) {

            } else {
            	content = document.getElementById("thong-so-san-pham");
            	if (content) {
            		
            	} else {
            		content = document.getElementById("tinh-nang-san-pham");
            	}
            }
            // alert('11');
            var content1 = document.getElementById("thong-so-ky-thuat");
            if (content1) {

            } else {
            	content1 = document.getElementById("dac-tinh-ky-thuat");
            	if (content1) {

            	} else {
            		content1 = document.getElementById("thong-tin-ky-thuat");
            	}
            }
            // alert('111');
            var content2 = document.getElementById("huong-san-su-dung");
            // alert('1111');
            ...
            var img = document.getElementsByClassName("yith_magnifier_zoom woocommerce-main-image");
			...
			var img_con = document.getElementsByClassName("attachment-shop_thumbnail")[0];
			if (img_con) {
				var img = document.getElementsByClassName("attachment-shop_thumbnail");
				var img_pro_length = img.length;//alert(img_pro_length);
	            var img_pro_arr = [];
	            var imgTags;
	            // var img = document.getElementById("imgID").src;
