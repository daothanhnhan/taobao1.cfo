...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            des = '';
            var content = document.getElementById("tab_thông-tin-sản-phẩm");
            var content1 = document.getElementById("tab_mô-tả-sản-phẩm");
            var content2 = document.getElementById("tab_hướng-dẫn-sử-dụng");
            // alert('1');
            // var content3 = document.getElementsByClassName("video")[0];
            ...
            // content3 = content3.innerHTML.replaceAll(/\t/g,'');
// alert('2');
			...
			content = content.replaceAll("col medium-2 small-12 large-2", "");
            // alert(content);
            
            var img = document.getElementsByClassName("box-image");
