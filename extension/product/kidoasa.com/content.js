...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            if (price || true) {
            	var price1 = document.getElementsByClassName("woocommerce-Price-amount")[0];
	            ...
	            // alert(price2);
	            var price2 = document.getElementsByClassName("woocommerce-Price-amount")[1];
            ...
            des = '';
            var content = document.getElementById("ftwp-postcontent");
            des = content.firstChild.innerHTML;
            // alert(des);
            ...
            var img = document.getElementsByClassName("wp-post-image");
