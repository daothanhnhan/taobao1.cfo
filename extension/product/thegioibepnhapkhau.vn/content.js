...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var price = document.getElementsByClassName("txt_d")[0];

            if (price) {
            	var price1 = document.getElementsByClassName("txt_d")[0];
	            ...
	            // alert(price2);
	            var price2 = document.getElementsByClassName("txt_red txt_20")[0];
	            // alert(price2.innerHTML);
	            // price2 = price2.getElementsByTagName("span")[0];
	            // alert(price2);
            ...
            des = '';
            var content = document.getElementById("tbl_description");
