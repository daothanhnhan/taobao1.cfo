    ...
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            if (price) {
            	...
            	// alert('1');
            	var price1 = document.getElementsByClassName("price")[0];//alert(price1);
            ...
            var des = document.getElementsByClassName("khuyenmai")[0];
            ...
            // des = '';
            // alert(des);
            var content = document.getElementById("tinhnang");
            var content1 = document.getElementById("tab_2");//alert(content1.innerHTML);
            var content2 = document.getElementById("dactinh");//alert(content2.innerHTML);
