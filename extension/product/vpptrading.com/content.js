...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var price = document.getElementsByClassName("price product-price")[0];
            ...
            if (price) {
	            ...
	            // alert(price2);
	            var price2 = document.getElementsByClassName("special-price")[0];
            ...
            // var des = document.getElementsByClassName("product_description")[0];
            // alert(des.innerHTML.replaceAll(/\s/g,''));
            // des = des.innerHTML.replaceAll(/\t/g,'');
            // alert('a');
            // document.body.innerHTML = des;
            // des = des.replace('Giao Hàng Lắp Đặt&nbsp;Miễn Phí', '');
            // des = des.replace('Đổi Trả Sản Phẩm&nbsp;7 Ngày (<a href="http://boschluxury.vn/bao-hanh-san-pham">Chính sách bảo hành</a>)', '');
            // des = des.replace('Gọi Ngay Hotline&nbsp;<span style="color:#e74c3c;"><strong>0901 39 94 39</strong>', '');
            // des = des.replace('&nbsp;Để Có Giá Tốt Nhất', '');
            // alert('b');
            // des = des.innerHTML;
            // des = encodeURIComponent(des);

            des = '';
            // var content = document.getElementsByClassName("rte")[0];
            var content = document.getElementById("tab-1");
            ...
            var img = document.getElementsByClassName("img_bigg");
			...
			for (i=0;i<img_pro_arr.length;i++) {
				...
				link_src = link_src.replace('thumb/large/', '');
				// alert(src[0]);
