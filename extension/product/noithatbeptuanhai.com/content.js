    ...
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            if (price && false) {
            	...
            	// alert('1');
            	var price1 = document.getElementsByClassName("woocommerce-Price-amount amount")[1];
            	// alert(price1.innerHTML);
            	// alert(price1.innerText);
            	price1 = price1.innerHTML;//alert(price1);
	            price1 = price1.replace(/\D/gm,"");
