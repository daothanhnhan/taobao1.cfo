...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var khung = document.getElementsByClassName("summary-inner")[0];//alert(khung.innerHTML);
            var gia = khung.getElementsByClassName("price")[2];//alert(gia.innerHTML);
            var price = gia.getElementsByClassName("woocommerce-Price-amount");
            // alert(price.length);

            if (price.length == 2) {
            	// alert('hai gia');
            	var price1 = gia.getElementsByClassName("woocommerce-Price-amount")[0];//alert(price1.innerHTML);
	            price1 = price1.innerHTML;
	            ...
	            // alert(price2);
	            var price2 = gia.getElementsByClassName("woocommerce-Price-amount")[1];
	            price2 = price2.innerHTML;
	            price2 = price2.replace(/\D/gm,"");
	            // alert(price2);
            } else {
            	// alert('1');
            	var price1 = gia.getElementsByClassName("woocommerce-Price-amount")[0];//alert(price1);
            ...
            var img = document.getElementsByClassName("product-image-thumbnail");
