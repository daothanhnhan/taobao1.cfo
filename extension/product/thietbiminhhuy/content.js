...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var des = document.getElementsByClassName("tinymce")[0];
...
// alert('a');
			...
			sendResponse({code: code, text: h2.innerText, price1: price1, price2: price2, des: des, content: content, img: arr_img, img_content: arr_img_content, method: "changePage"});
        }
