...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            var des = document.getElementsByClassName("inline")[2];
            // alert(des.innerHTML);
            var des = des.getElementsByTagName("p")[0];
            // alert(des.innerHTML);
            ...
            des = '';
            var content = document.getElementById("caracteristicas");
            var content1 = document.getElementById("ficha");//alert(content1.innerHTML);
            ...
            var img = document.getElementsByClassName("img-producto");
            ...
            for (var i=0;i<img_pro_length;i++) {
            	...
            	// alert
            	imgTags = img[i].srcset;
            	imgTags = imgTags.replace("_mobile", "");
			...
			sendResponse({text: h2, price1: price1, price2: price2, des: des, content: content, img: img_pro_arr, img_content: arr_img_content, method: "changePage"});
        }
