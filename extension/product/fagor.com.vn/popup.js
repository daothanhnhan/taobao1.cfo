    ...
    chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
        chrome.tabs.sendMessage(tabs[0].id, {method: "changePage"}, function(response) {
          ...
          for (var i=0;i<img.length;i++) {
            img_src += '<a href="http://www.fagor.com.vn'+img[i]+'" class="img_product" download><img src="http://www.fagor.com.vn'+img[i]+'" width="100"></a>';
          }
          ...
          for (var i=0;i<img_content.length;i++) {
            img_src_content += '<a href="http://www.fagor.com.vn'+img_content[i]+'" class="img_content" download><img src="http://www.fagor.com.vn'+img_content[i]+'" width="100"></a>';
          }
