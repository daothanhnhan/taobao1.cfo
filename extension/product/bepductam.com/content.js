...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if(request.method == "changePage"){
            ...
            if (price) {
            	var price1 = document.getElementsByClassName("price-old")[0];
	            ...
	            // alert(price2);
	            var price2 = document.getElementsByClassName("price")[0];
            ...
            des = '';
            var content = document.getElementsByClassName("list-spec")[0];
            ...
            var img = document.getElementsByClassName("detail-header-1");
